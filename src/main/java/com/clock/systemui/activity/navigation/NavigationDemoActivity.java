...
public class NavigationDemoActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_net_easycloud).setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        } else if (viewId == R.id.btn_net_easycloud) {
            Intent netEasyCloudIntent = new Intent(this, NetEasyCloudActivity.class);
            startActivity(netEasyCloudIntent);
